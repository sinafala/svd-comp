#' SVD-Comp Models Data Set - 'mods2018'.
#'
...
#'     reduces their size. This is the 2018 version of the models that replicates
#'     the \emph{Demography} paper.
#'
