...
write(as.numeric(format(Sys.time(), "%s")),file="../Rmd/started.txt")
...
The data come from the Human Mortality Database (HMD) and are available online at [www.mortality.org - **click here**](www.mortality.org). To get the latest HMD, go to the HMD web site, sign up for an account, and download the 'All HMD statistics zip file' (maybe at [https://www.mortality.org/File/Download/hmd.v6/zip/all_hmd/hmd_statistics_20241010.zip](https://www.mortality.org/File/Download/hmd.v6/zip/all_hmd/hmd_statistics_20241010.zip)). The code below is used to process the contents of that file to extract the life tables.
...
# REMEMBER TO RENAME THIS WITH EACH UPDATE OF HMD
# create and same the models object for the package
mods2024 <- make.models(mod.1_0.f,mod.1_0.sm.f,mod.1_0.m,mod.1_0.sm.m)
# have a look at it
mods2024
save(file="../RData/mods2024.RData",compress=TRUE,list=c("mods2024"))
