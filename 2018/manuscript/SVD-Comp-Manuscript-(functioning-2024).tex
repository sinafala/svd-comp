...
\usepackage{xr}
\externaldocument{"SVD-Comp-Appendices-(functioning-2024)"}
...
% fix \input so that it is 'expandable' and can be used in tabular environments 
...
\multicolumn{5}{l}{\textit{Female}} \\
 \midrule
 \expandableinput{../tables/compsFemale.txt}
 \midrule
\multicolumn{5}{l}{\textit{Male}} \\
 \midrule
 \expandableinput{../tables/compsMale.txt}
\bottomrule
\end{tabular}
\end{center}
\label{tab:absErrs}
